    ...
    <div id="travel" class="traveling">
        <div class="container">
            <div class="row">
                <div class="col-md-12 ">
                    <div class="titlepage">
                        <h2>List Ilmuwan Tersedia</h2>
                        <span>Ilmuwan di bawah ini adalah mereka yang paling berjasa dalam memajukan peradaban dunia, lho. Tim dari SqientzPedia sudah mengumpulkan banyak sekali informasi tentang mereka. Penasaran? Yuk, kenali siapa mereka.</span>
                    </div>
                </div>
            </div>
            <div class="row">
