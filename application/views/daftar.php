...
<body oncontextmenu="return false" class="snippet-body">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <div class="card">
          <form class="box" action="<?php echo base_url() ?>account/proses_regis" method="post">
            ...
            <input type="text" name="nama" placeholder="Full Name" maxlength="30" required />
            <i style="color: red;"><?php echo form_error('nama'); ?></i>

            <input type="text" name="username" placeholder="Username" maxlength="30" required />
            <i style="color: red;"><?php echo form_error('username'); ?></i>

            <input type="password" name="password" placeholder="Password" minlength="5" id="password" required />
            <i style="color: red;"><?php echo form_error('password'); ?></i>

            <input type="password" name="confirm_password" placeholder="Confirm Password" minlength="5" id="confirm_password" required />
            <?php
            if ($this->session->flashdata('pesan_pass')) { ?>
              <div class="alert alert-danger">
                <?php echo $this->session->flashdata('pesan_pass'); ?>
              </div>
            <?php } ?>

            <a class="forgot text-muted" href="<?php echo base_url() ?>account/login">Already have an Account?</a>
